    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center px-6 py-12 space-y-16">
      ...
      <section className="text-center max-w-4xl space-y-6">
        <div className="flex flex-col items-center gap-4 sm:gap-6">
          ...
          Video Coach — The next-generation coaching platform. We deliver fast, affordable human insight with 3× higher response rates than traditional surveys that reveal what truly drives high-performance team
          </p>
