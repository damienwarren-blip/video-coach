...
import { ChatBubbleBottomCenterTextIcon, ChartBarIcon, RocketLaunchIcon } from "@heroicons/react/24/outline";
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center px-6 py-12 space-y-16">
      ...
      <section className="text-center max-w-3xl space-y-6">
        ...
        <div className="mt-8 flex justify-center w-full">
          <div className="w-full max-w-3xl aspect-video sm:rounded-xl shadow-lg">
            <iframe
      ...
      {/* CTA Section */}
      <section className="bg-blue-600 text-white w-full py-12 flex flex-col items-center space-y-4 rounded-xl shadow-lg">
        ...
        <button className="mt-4 px-8 py-3 bg-white text-blue-600 rounded-full hover:bg-gray-100 transition font-medium text-lg">
          Book a Demo
        </button>
      </section>
