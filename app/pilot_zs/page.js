        ...
        {!confirmed ? (
          <div>
            ...
            <header className="text-center mb-6">
              ...
              <p className="mt-2 text-sm sm:text-base text-gray-600">Quick, anonymous feedback that actually makes a difference.</p>
            </header>
            ...
            <section className="grid gap-4 sm:grid-cols-2 mb-6">
              <div className="p-4 rounded-xl bg-gradient-to-br from-violet-50 to-fuchsia-50 border border-violet-100 transform transition hover:scale-105 sm:col-span-2">
                ...
                <p className="text-sm text-gray-600 mt-1">Reply with text or video. Share what’s working and what’s not — help us improve fast.</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-100 transform transition hover:scale-105">
                ...
                <p className="text-sm text-gray-600 mt-1">No sign-in, no names — just your thoughts. Avoid personal info.</p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-fuchsia-50 to-pink-50 border border-fuchsia-100 transform transition hover:scale-105">
                ...
                <p className="text-sm text-gray-600 mt-1">Every response is reviewed — anonymized feedback drives real improvements.</p>
              </div>
            </section>
          ...
          <div>
            <div className="mb-4 text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">100% anonymous — just you and your thoughts.</p>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-xl bg-white rounded-2xl shadow-2xl p-6">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Short video-style feedback — type or record a video. No personal info.
            </p>
            ...
            <p className="text-xs text-gray-500 mt-3">AI only groups themes and removes potential identifiers. Raw responses deleted within 90 days.</p>
          </div>
        </div>
      )}
