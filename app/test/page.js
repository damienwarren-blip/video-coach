...
export default function AIGovernanceReport() {
    ...
    return (
        ...
        <div style={styles.page}>
            ...
            <tbody>
                <tr>
                <td style={styles.td}>Efficiency gains</td>
                <td style={{...styles.td, ...styles.lowRisk}}>Automate compliance, fraud detection & manual reporting</td>
                <td style={styles.td}>55%</td>
                <td style={styles.td}>Productivity</td>
                </tr>
                <tr>
                <td style={styles.td}>Major concerns</td>
                <td style={{...styles.td, ...styles.highRisk}}>Data leakage, undefined ownership & regulatory fines</td>
